...
#define EXP_FUNC virtual TagString expFunc ( const AbstractListPanel*, const TagStringList&, const bool&, Expander& ) const
#define SIMPLE_EXP_FUNC virtual TagString expFunc ( const AbstractListPanel*, const QStringList&, const bool&, Expander& ) const
/**
...
protected:
    ...
    static QStringList fileList(const AbstractListPanel* const panel, const QString& type, const QString& mask, const bool omitPath, const bool useUrl, Expander&, const QString&);
    exp_placeholder();
...
protected:
     ...
     */
    static AbstractListPanel* getPanel(const char panelIndicator , const exp_placeholder*, Expander&);
    /**
