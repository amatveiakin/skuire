...
public:
    ...
    virtual void saveSettings(KConfigGroup cfg, bool saveHistory = false);
...
protected slots:
    ...
    void slotFocusOnMe();
    void handleDragOverView(QDragMoveEvent *, QWidget *destWidget = 0);
    void handleDragLeavesView(QDragLeaveEvent *);
